...
set_property -dict [list CONFIG.Component_Name {mybram} CONFIG.Memory_Type {Single_Port_RAM} CONFIG.Assume_Synchronous_Clk {false} CONFIG.Write_Width_A {6} CONFIG.Write_Depth_A {64} CONFIG.Read_Width_A {6} CONFIG.Operating_Mode_A {WRITE_FIRST} CONFIG.Enable_A {Use_ENA_Pin} CONFIG.Write_Width_B {6} CONFIG.Read_Width_B {6} CONFIG.Operating_Mode_B {WRITE_FIRST} CONFIG.Enable_B {Always_Enabled} CONFIG.Register_PortA_Output_of_Memory_Primitives {true} CONFIG.Register_PortB_Output_of_Memory_Primitives {false} CONFIG.Load_Init_File {true} CONFIG.Coe_File {/home/centos/CWM-ECAD/Ex7/mybram_coe.coe} CONFIG.Fill_Remaining_Memory_Locations {true} CONFIG.Port_A_Write_Rate {50} CONFIG.Port_B_Clock {0} CONFIG.Port_B_Enable_Rate {0}] [get_ips mybram]
